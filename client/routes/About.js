	...
	render: function() {
		return (
	  	<div className="jumbotron">
		    ...
		    <p>This is a web application to serve as an interactive diary to be used by the patient, their family, and the nursing staff. ICU survivors have a much higher incidence of depression and PTSD symptoms, which is believed to be caused by psychological trauma during their stay in the ICU. Some research has indicated that keeping a plain language diary for the patient can help them to make sense of their stay in the ICU and reduce psychological trauma.</p>
